...
public class TimePickerActivity extends AppCompatActivity {
                ...
                public void onTimeSet(@Nullable TimePicker view, int hourOfDay, int min){
                    String formattedTime = hourOfDay == 0 ?(min < 10 ? hourOfDay + 12 + ":0" + min +
                            ...
                            (hourOfDay > 12 ? (min < 10 ? hourOfDay - 12 + ":0" + min +
                                    ...
                                    " am" : "" + hourOfDay + ':' + min + " am")));
                    TimePickerActivity.this.getPreviewSelectedTime().setText((CharSequence)formattedTime);
                }
    });
                    ...
                    String formattedTime = hourOfDay == 0 ?(min < 10 ? hourOfDay + 12 + ":0" + min +
                            ...
                            (hourOfDay > 12 ? (min < 10 ? hourOfDay - 12 + ":0" + min +
                                    ...
                                    (min < 10 ? hourOfDay + ":0" + min + " pm" : "" +
                                            hourOfDay + ':' + min + " pm") : (min < 10 ? "" + hourOfDay + ':' + min +
                                    " am" : "" + hourOfDay + ':' + min + " am")));
                    TimePickerActivity.this.getPreviewSelectedEndTime().setText((CharSequence) formattedTime);
                }
            });
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        user = (Customer) i.getSerializableExtra("usertype");
        ...
        btnPickTime.setOnClickListener((View.OnClickListener) new View.OnClickListener(){
            public final void onClick(View view){
                TimePickerDialog timePicker = new TimePickerDialog(TimePickerActivity.this,
                        TimePickerActivity.this.timePickerDialogListener,12,10,false);
                timePicker.show();
        ...
        btnPickEndTime.setOnClickListener((View.OnClickListener) new View.OnClickListener(){
            public final void onClick(View view){
                TimePickerDialog timePicker = new TimePickerDialog(TimePickerActivity.this,
                        TimePickerActivity.this.timePickerDialogListener2,12,10,false);
                timePicker.show();
    ...
    public void submitInfo(View v){
        Intent intent = new Intent(TimePickerActivity.this, CustomerActivity.class);
